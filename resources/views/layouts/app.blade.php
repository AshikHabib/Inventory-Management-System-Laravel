...
<body>
                            ...
                            <div class="topbar">
                                ...
                                <div class="topbar-left">
                                    <div class="text-center">
                                        <a href="{{ route('home') }}" class="logo"><i class="fas fa-warehouse"></i> <span>Inventory</span></a>
                                    </div>
                                </div>
                            ...
                            <div class="left side-menu">
                                <div class="sidebar-inner slimscrollleft">
                                    <div class="user-details">
                                        ...
                                        <div class="user-info">
                                            <div class="dropdown">
                                                <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">MD. Aminul Haque <span class="caret"></span></a>
                                                <ul class="dropdown-menu">
                                    ...
                                    <div id="sidebar-menu">
                                        <ul>
                                            <li>
                                                <a href="{{ route('home') }}" class="waves-effect"><i class="fas fa-home"></i><span> Dashboard </span></a>
                                            </li>

                                            <li>
                                                <a href="{{ route('pos') }}" class="waves-effect"><i class="fas fa-tachometer-alt"></i><span> POS</span></a>
                                            </li>

                                            <li class="has_sub">
                                                <a href="#" class="waves-effect"><i class="fas fa-envelope"></i><span> Mail </span><span class="pull-right"><i class="md md-add"></i></span></a>
                                            ...
                                            <li class="has_sub">
                                                ...
                                                <ul class="list-unstyled">
                                                    <li><a href="{{ route('add.employee') }}"><i class="fas fa-address-card"></i> Add New</a></li>
                                                    <li><a href="{{ route('all.employee') }}"><i class="fas fa-th"></i> View All</a></li>
                                                </ul>
                                            </li>

                                            <li class="has_sub">
                                                <a href="#" class="waves-effect"><i class="fas fa-shopping-cart"></i><span> Customers </span><span class="pull-right"><i class="md md-add"></i></span></a>
                                                <ul class="list-unstyled">
                                                    <li><a href="{{ route('add.customer') }}"><i class="fas fa-address-card"></i> Add New</a></li>
                                                    <li><a href="{{ route('all.customer') }}"><i class="fas fa-th"></i> View All</a></li>
                                                </ul>
                                            </li>

                                            <li class="has_sub">
                                                <a href="#" class="waves-effect"><i class="fas fa-truck-moving"></i></i><span> Suppliers </span> <span class="pull-right"><i class="md md-add"></i></span></a>
                                                <ul class="list-unstyled">
                                                    <li><a href="{{ route('add.supplier') }}"><i class="fas fa-address-card"></i> Add New</a></li>
                                                    <li><a href="{{ route('all.supplier') }}"><i class="fas fa-th"></i> View All</a></li>
                                                </ul>
                                            </li>

                                            <li class="has_sub">
                                                <a href="#" class="waves-effect"><i class="fas fa-money-bill-wave"></i><span> Salary </span> <span class="pull-right"><i class="md md-add"></i></span></a>
                                                <ul class="list-unstyled">
                                                    <li><a href="{{ route('add.advancedsalary') }}"><i class="fas fa-address-card"></i> Pay Advance</a></li>
                                                    <li><a href="{{ route('all.advancedsalary') }}"><i class="fas fa-th"></i> View All Advanced</a></li>
                                                    <li><a href="{{ route('pay.salary') }}">Pay Salary</a></li>
                                                    <li><a href="">Last Month Salaries</a></li>
                                                </ul>
                                            </li>

                                            <li class="has_sub">
                                                <a href="#" class="waves-effect"><i class="fas fa-border-all"></i><span> Categories </span> <span class="pull-right"><i class="md md-add"></i></span></a>
                                                <ul class="list-unstyled">
                                                    <li><a href="{{ route('add.category') }}"><i class="fas fa-address-card"></i> Add Category</a></li>
                                                    <li><a href="{{ route('all.category') }}"><i class="fas fa-th"></i> All Categories</a></li>
                                                </ul>
                                            </li>
                                            ...
                                            <li class="has_sub">
                                                ...
                                                <ul class="list-unstyled">
                                                    <li><a href="{{ route('add.product') }}"><i class="fas fa-address-card"></i> Add Product</a></li>
                                                    <li><a href="{{ route('all.product') }}"><i class="fas fa-th"></i> All Products</a></li>
                                                </ul>
                                            </li>

                                            <li class="has_sub">
                                                <a href="#" class="waves-effect"><i class="fas fa-hand-holding-usd"></i><span> Expenses </span> <span class="pull-right"><i class="md md-add"></i></span></a>
                                                <ul class="list-unstyled">
                                                    <li><a href="{{ route('add.expense') }}"><i class="fas fa-address-card"></i> Add New</a></li>
                                                    <li><a href="{{ route('today.expense') }}"><i class="fas fa-receipt"></i> Today's Expenses</a></li>
                                                    <li><a href="{{ route('monthly.expense') }}"><i class="fas fa-receipt"></i> Monthly Expenses</a></li>
                                                    <li><a href="{{ route('yearly.expense') }}"><i class="fas fa-receipt"></i> Yearly Expenses</a></li>
                                                </ul>
                                            </li>

                                            <li class="has_sub">
                                                <a href="#" class="waves-effect"><i class="fas fa-file-invoice-dollar"></i><span> Sales Report </span> <span class="pull-right"><i class="md md-add"></i></span></a>
                                                <ul class="list-unstyled">
                                                    <li><a href="#"><i class="fas fa-address-card"></i> First</a></li>
                                                    <li><a href="#"><i class="fas fa-receipt"></i> Second</a></li>
                                                </ul>
                                            </li>

                                            <li class="has_sub">
                                                <a href="#" class="waves-effect"><i class="fas fa-user-friends"></i><span> Attendance </span> <span class="pull-right"><i class="md md-add"></i></span></a>
                                                <ul class="list-unstyled">
                                                    <li><a href="{{ route('take.attendance') }}"><i class="fas fa-user-check"></i> Take Attendance</a></li>
                                                    <li><a href="{{ route('all.attendance') }}"><i class="fas fa-users"></i> All Attendance</a></li>
                                                    <li><a href="#"><i class="fas fa-users"></i> Monthly Attendance</a></li>
                                                </ul>
                                            </li>
                                             ...
                                             <li class="has_sub">
                                                ...
                                                <ul class="list-unstyled">
                                                    <li><a href="{{ route('setting') }}"><i class="fas fa-sliders-h"></i> Information Setting</a></li>
                                                </ul>
                                            </li>
            ...
            $(document).on("click", "#delete", function(e){
                ...
                var link = $(this).attr("href");
                    swal({
                        ...
                        text: "Once deleted, This will be removed permanently!",
                        icon: "warning",
                        buttons: true,
                        dangerMode: true,
                    })
    ...
    <!-- DataTables -->
    <script src="{{asset('assets/magnific-popup/magnific-popup.js')}}"></script>
