                    ...
                    <div class="col-md-2"></div>
                            <div class="col-md-8">
                                <div class="panel panel-info">
                                    <div class="panel-heading"><h3 class="panel-title text-white">Add New Category</h3></div>
                                    @if ($errors->any())
                                    ...
                                    <div class="panel-body">
                                        <form role="form" action="{{ url('/insert-category') }}" method="POST">
                                            ...
                                            <a href="{{ route('all.category') }}" class="btn btn-lg btn-info waves-effect waves-light">Show All Categories</a>
