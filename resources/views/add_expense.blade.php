                    ...
                    <div class="col-md-2"></div>
                            <div class="col-md-8">
                                <div class="panel panel-info">
                                    <div class="panel-heading"><h3 class="panel-title text-white">Add New Expense</h3>
                                    </div>
                                    ...
                                    <div class="panel-body">
                                        <form role="form" action="{{ url('/insert-expense') }}" method="POST">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="amount" placeholder="Amount (Tk.)" required>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <button type="submit" class="btn btn-lg btn-success waves-effect waves-light"><i class="fas fa-save"></i> Save</button>

                                            <a href="{{ route('today.expense') }}" class="pull-right btn btn-md btn-danger waves-effect waves-light">Today's Expenses</a>
                                        	<a href="{{ route('monthly.expense') }}" class="pull-right btn btn-md btn-warning waves-effect waves-light">Monthly Expenses</a>
