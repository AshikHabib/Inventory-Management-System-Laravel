    ...
    <div class="content-page">
        ...
        <div class="content">
            <div class="container">
                <div class="row">
                    <div class="col-sm-12">
                        <h4 class="pull-left page-title">Edit Attendance {{ $date->att_date }}</h4>
                        ...
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="m-b-30">
                                            ...
                                            <h4 class="badge badge-success" style="color: white; font-size: 20px;">Update Attendance</h4>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <form action="{{ url('/update-attendance') }}"  method="POST">
	                                        ...
	                                        @foreach($edit as $row)
	                                            ...
	                                            <input type="hidden" name="id[]" value="{{ $row->id }}">
	                                                <td>
	                                                    ...
	                                                    <input type="radio" name="attendance[{{ $row->id }}]" value="Absent" required <?php if($row->attendance =='Absent'){
	                                                    	echo "checked";
	                                                    	} ?>> Absent
	                                                </td>
                                	...
                                	<button type="submit" class="btn btn-lg btn-success">Update Attendance</button>
